...
public class Lecturers {
    ...
    public Lecturers(int id, String username, String password, int roll_ID, String fullName, int gender, String address, String email, String phoneNumber, Date birthDate, int status, String imgCertificate, String imgProfile, String description) {
        this.id = id;
