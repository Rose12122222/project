                ...
                <div class="row">
                  ...
                  >
                    <span class="pm-name-text bold"
                      >BachLQHE171251@fpt.edu.vn</span
                    >
                  </div>
                  <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
                </div>
                ...
                <div class="pm-certificate-footer">
                  <div class="col-xs-4 pm-certified col-xs-4 text-center">
                    ...
                    <span class="bold block"
                      >Jame Smith Instructional Specialist II, Staff
                      Development</span
                    >
                  </div>
                  <div class="col-xs-4">
                  ...
                  <div class="col-xs-4 pm-certified col-xs-4 text-center">
                    <span class="pm-credits-text block sans"
                      >Date Completed</span
                    >
                    <span class="pm-credits-text block sans">17/5/2024</span>
                    <span class="pm-empty-space block underline"></span>
                  </div>
                </div>
              </div>
