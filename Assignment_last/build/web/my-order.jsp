...
<html class="no-js" lang="zxx">
    ...
    <style>
        ...
        .table_desc table thead tr th.order_id{
            min-width: 180px;
        }
        .table_desc table thead tr th.order_date, .table_desc table thead tr th.order_status{
            min-width: 310px;
        }
        .table_desc table thead tr th.order_total{
            min-width: 369px;
        }
    </style>
    <body>
                                        ...
                                        <div class="pagination_style" style="margin-bottom: 0">
                                            ...
                                            <div class="page_number">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="my-order?page=1">«</a></li>
                                                        <c:forEach var="i" begin="1" end="${sessionScope.numberOfPageMyOrder}">
                                                            <c:choose>
                                                                <c:when test="${i == currentPage}">
                                                                <li class="current_number">${i}</li>
                                                                </c:when>
                                                                <c:otherwise>
                                                                <li><a href="my-order?page=${i}">${i}</a></li>
                                                                </c:otherwise>
                                                            </c:choose>                                             
                                                        </c:forEach>
                                                    <li><a href="my-order?page=${sessionScope.numberOfPageMyOrder}">»</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
