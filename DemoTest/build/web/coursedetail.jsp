<%-- 
    ...
    Created on : May 22, 2024, 3:01:16 PM
    Author     : Windows
--%>
        ...
        <div class="container-fluid bg-dark text-white p-5">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="text-wrap">
                        Vài dòng giới thiệu về khóa học, ví dụ như: JUST COMPLETELY REDONE -
                        The only course you need to learn web development - HTML, CSS, JS,
                        Node, and More!
                    </p>
                    <span class="checked"><strong> 4.7</strong></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star-half-o checked"></span>
                    <p class="pt-3">Instructor : <a href="#">James Smith</a></p>
                    <p>Date Update : 20/11//2024</p>
                ...
                <div class="col-md-5 image text-center">
                    <img src="images/c++.jpg" alt="Course Image" class="img-fluid mb-3" width="400" />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 p-5 ">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item home-tab">
                        <a class="nav-link " href="#course-intro" style="font-size: 20px">Introduce</a>
                    </li>
                    <li class="nav-item home-tab">
                        <a class="nav-link " href="#course-content" style="font-size: 20px">Content</a>
                    </li>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#course-teacher" style="font-size: 20px">Lucturers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#student-feedback" style="font-size: 20px">Reviews</a>
                    </li>
                    <li class="nav-item">
                ...
                <div style="background-color: #DAF0BE;" class="p-3">
                    ...
                    <ul>
                        <li>Key data science and machine learning concepts right from the beginning with a complete unfolding with
                ...
                <div class="row p-3" id="course-content">
                    <hr>
                    <h2 class="heading-xl">Course's Syllabus is the following:</h2>
                    <div class="row">
                        <div class="col-md-8">
                            <ul>
                                <i class="fa fa-play-circle"></i>
                                <a href="#" style="color: black">
                                    Installations of PyCharm - Most popular IDE (Where we write our
                                    code)</a>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <ul>
                                <i class="fa fa-play-circle"></i>
                                <a href="#" style="color: black">
                                    Installations of Python , step-by-step configurations</a>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <ul>
                                <i class="fa fa-play-circle"></i>
                                <a href="#" style="color: black"> IVariables - Strings</a>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <ul>
                                <i class="fa fa-play-circle"></i>
                                <a href="#" style="color: black"> Variables - String Formatting</a>
                            </ul>
                        </div>
                ...
                <div class="row p-3" id="course-teacher">
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-md-1">
                                <img src="images/instructor.jpg" alt="" class="rounded-circle teacher-avt" width="80" />
                            </div>
                            <div class="col-md-3">
                                <span class="fa fa-star checked"></span>
