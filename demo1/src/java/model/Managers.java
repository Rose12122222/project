...
public class Managers {
    ...
    public Managers(int id, String username, String password, int roll_ID, String fullName, int gender, String address, String email, String phoneNumber, String birthDate, String imgProfile) {
        this.id = id;
